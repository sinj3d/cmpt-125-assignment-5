...
a5: a5.cpp data_collector.cpp neural_net.cpp a5.h data_collector.h neural_net.h
	g++ $(CPPFLAGS) a5.cpp data_collector.cpp neural_net.cpp -o a5.exe

clean:
	rm -f a5.exe dataset.csv weights.txt
